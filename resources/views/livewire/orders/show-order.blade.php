                ...
                <div class="flex justify-between border-b-2 border-gray-200">
                    ...
                    <div>
                        <div class="m-2 pt-0 relative text-gray-600">
                            <input class="border-2 border-gray-300 bg-white h-11 px-5 pr-16 rounded-lg text-sm focus:outline-none" type="search" name="search" placeholder="Buscar por ordem" wire:model="search">
